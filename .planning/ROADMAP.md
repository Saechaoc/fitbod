...
- [ ] **Phase 1: Foundation & Exercise Library** — Versioned SwiftData schema, full entity set, library seed pipeline, browse/filter/custom-creation UI
...
|-------|----------------|--------|-----------|
| 1. Foundation & Exercise Library | 8/12 | In Progress|  |
